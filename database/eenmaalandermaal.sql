...
INSERT INTO dbo.users (username, email, password, first_name, last_name, address, postal_code, city, country_code, birth_date, security_question_id, security_answer, is_seller)
VALUES ('koper', 'koper@mail.com', '$2y$10$dyjvsG8FpkB13AAkGuEQsOxt84O9fJk9E6nTsUmYvk87Ei5z4XtRe', 'Voorbeeld', 'Koper', 'Ruitenberglaan 26', '6826CC', 'Arnhem', 'NL', '01-01-2000', 0, 'Hond', 0),
	('verkoper', 'verkoper@mail.com', '$2y$10$dyjvsG8FpkB13AAkGuEQsOxt84O9fJk9E6nTsUmYvk87Ei5z4XtRe', 'Voorbeeld', 'Verkoper', 'Ruitenberglaan 26', '6826CC', 'Arnhem', 'NL', '01-01-2000', 0, 'Hond', 1)

INSERT INTO dbo.seller_verifications (user_id, method, bank_name, bank_account_number)
VALUES (1, 'Bank', 'Testbank', 'NL13TEST0123456789')